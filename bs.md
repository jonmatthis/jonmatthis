...
I'm planning to submit roughly 4 proposals between now and Oct - representing the NIH- and NSF-flavored versions of two types of grants: two grants to support FOSS projects (NSF: POSE, NIH: BRAIN BBQS), and one SBIR/STTV each to both agencies. 
