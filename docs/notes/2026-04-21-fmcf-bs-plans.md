...
The NSF-STTR will prob be similar, but more geared towards building low-cost freemocap teaching kits. Same data model as the ferrets, but very different focus. That one will pair the FreeMoCap Foundation with its own for-profit SkellyTech, LLC (apparently a common move for non-university non-profits). 
